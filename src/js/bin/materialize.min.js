...
window.cash = (function () {
    ...
    function b(t, e) {
        var i =
            t &&
            (t.matches || t.webkitMatchesSelector || t.mozMatchesSelector || t.msMatchesSelector || t.oMatchesSelector);
        return !!i && i.call(t, e);
    }
    function w(e) {
        return d(e)
            ...
            (n <= a || !e) && (k.began || ((k.began = !0), p('begin')), p('run')),
                ...
                e <= t &&
                    (k.remaining
                        ...
                        : (k.pause(),
                          k.completed || ((k.completed = !0), p('complete'), 'Promise' in window && (_(), (y = d())))),
                    (g = 0));
        }
        t = void 0 === t ? {} : t;
        var f,
